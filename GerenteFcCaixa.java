 ...
 * @author Lincon
 */
public class GerenteFcCaixa extends javax.swing.JFrame {

    String id, usuario, senha, funcao;
    
    private FecharCaixa fcaixa;
   
    
    public GerenteFcCaixa() {
        initComponents();
        
        fcaixa = new FecharCaixa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenteFcCaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GerenteFcCaixa().setVisible(true);
            }
        });
    }
